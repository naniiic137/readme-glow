      ...
      <div className="tb-right">
        ...
        <Menu
          ...
          items={[
            ...
            { id: 'gh-export', icon: <Icon name="github" size={16} />, label: 'GitHub export…', onSelect: () => openDialog('githubExport') },
            { id: 'share', icon: <Icon name="share" size={16} />, label: 'Share & access…', onSelect: () => openDialog('share') },
